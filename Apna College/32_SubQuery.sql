...
select * from professor where id in (select id from resident where age>20 and (address='Pune 1' or address='Pune 2'));
select * from professor where id in (select id from resident where age>20 and gender='Female' and (address='Pune 1' or address='Pune 2'));
drop table resident;
