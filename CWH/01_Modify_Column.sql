...
update employee set address='New Delhi' where id=1;
update employee set address='Mumbai' where id=2;
update employee set address='Bangalore' where id=3;
update employee set address='Chennai' where id=4;
update employee set address='Kolkata' where id=5;
update employee set address='Hyderabad' where id=6;
update employee set address='Pune' where id=7;
update employee set address='Ahmedabad' where id=8;
update employee set address='Surat' where id=9;
update employee set address='Jaipur' where id=10;
...
alter table employee modify column gender enum('Male', 'Female', 'Other') not null after name;
alter table employee modify column date_of_birth date first;
