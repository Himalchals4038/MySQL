...
select * from student;
alter table student add column refer_id int;
update student set refer_id = 1 where id in (2, 8, 4, 9, 3, 6);
update student set refer_id = 2 where id in (1, 5, 7, 10, 11, 18);
update student set refer_id = 3 where id in (12, 13, 16, 17);
update student set refer_id = 4 where id in (20, 22, 14, 23, 24);
update student set refer_id = 5 where id in (25, 21, 15, 19);
select s1.id, s1.name as student_name,
s2.name as refer_name
from student s1
inner join
student s2 on s1.refer_id = s2.id;
select id, name, refer_id from student
where refer_id in(
    select id from student where grade>10
);
drop table student;